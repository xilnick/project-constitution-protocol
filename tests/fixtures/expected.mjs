      ...
      "tiers": [
        {
          ...
          "routes": ["steps-implementer", "verification_command"],
          "escalates_to": "tier-1"
        },
        {
          "id": "tier-1",
          ...
          "routes": ["steps-planner", "steps-implementer", "step-verifier"],
        ...
        },
        {
          ...
          "routes": ["steps-planner", "steps-architect-pro", "steps-implementer", "step-verifier"],
          "escalates_to": "tier-2"
        },
        {
          "id": "tier-2",
          ...
          "routes": ["steps-architect-pro", "steps-implementer", "steps-fixer"],
          "escalates_to": null
        }
      ],
      "escalation_triggers": [
