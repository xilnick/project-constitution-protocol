...
const MUTATIONS = [
    ...
    ops: [
      {
        ...
        kind: 'replace',
        anchor: '| **Tier 1 (Standard)** |',
        replacement: '| **Tier 1 (Std)** |',
      },
      {
  ...
  },
  {
    ...
    ops: [{
      file: CONSTITUTION,
      kind: 'replace',
      anchor: '        label: "Tier 1 (Standard)"',
      replacement: '        label: "Tier 1 (Standardized)"',
    }],
    signature: 'golden document mismatch: ai-docs/constitution.yaml',
    mustFail: ['ai-docs/constitution.yaml matches the declared golden document'],
    mustPass: [...SUITE3],
  ...
  },
  {
    ...
    outcome: 'RED',
    ops: [{
      file: 'plugins/steps/agents/steps-impl-reviewer.md',
      kind: 'replace',
  ...
  },
  {
    ...
    outcome: 'RED',
    ops: [{
      file: 'plugins/steps/harnesses/codex/.codex/agents/steps-architect-pro.toml',
      kind: 'replace',
  ...
  },
  {
    ...
    ops: [{
      ...
      kind: 'replace',
      anchor: '| `steps-architect-pro` | `flash` |',
      replacement: '| `steps-architect-pro` | `pro` |',
    }],
    signature: 'FAIL E7 — each harness manifest and MODEL_ROUTING.md agree with the declared binding',
    mustFail: [],
    mustPass: [...SUITE3],
  ...
  },
  {
    ...
    outcome: 'RED',
    ops: [{
      file: 'plugins/toolbelt/skills/asl-intel/SKILL.md',
      kind: 'replace',
      anchor: 'asl intel callers',
      replacement: 'asl intel wipe',
    }],
    signature: 'FAIL U:asl-intel-query',
    mustFail: [],
    mustPass: [...SUITE3],
    max: 0,
  },
  {
    ...
    ops: [{
      file: CONSTITUTION,
      kind: 'replace',
      anchor: '        entry: "CRUD, a component edit, a local fix, a dependency bump."\n        stages: ["plan", "review", "implement"]',
      replacement: '        entry: "CRUD, a component edit, a local fix, a dependency bump."\n        stages: ["plan", "review"]',
    }],
    signature: 'omits the unskippable stage implement',
    mustFail: [
      'execution block declares the tier ladder and its escalation triggers',
      'ai-docs/constitution.yaml matches the declared golden document',
    ],
  ...
  },
  {
    ...
    outcome: 'RED',
    ops: [{
      file: 'plugins/steps/skills/steps-review/SKILL.md',
      kind: 'append',
  ...
  },
  {
    ...
    ops: [{
      file: 'plugins/steps/skills/steps/SKILL.md',
      kind: 'replace',
      anchor: '| Review | `steps-review` |',
      replacement: '| Review | `steps-check` |',
    }],
    signature: "the orchestrator's stage table never names steps-review",
    mustFail: [],
    mustPass: [...SUITE3],
    max: 0,
  },
