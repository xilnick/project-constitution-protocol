...
you can create your own `.plans/phase-N/IMPL-REVIEW-<lens>.md`. Writing anywhere else is a protocol
violation, not a judgment call. Use `bash` to observe: run a gate to record its current result,
